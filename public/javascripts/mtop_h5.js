...
function h5_base(){
    ...
    exports.isLogin = function(){
          var imewweoriw = exports.getCookie('imewweoriw');
          console.log(imewweoriw);

          return imewweoriw && imewweoriw.length > 32 ;
...
var _getMtopAppKey = function(){
    ...
    var mtop_app_key =  _getMtopAppKey();
...
/**
    ...
    var _send = function (url, app_key, data, callback, errorback) {
        var app_token = (tbh5.getCookie(tokenKey) || '').split('_')[0];
