...
KISSY.add("prototype", function (S, Node, RichBase, DD, undefined) {
        ...
        for (i = 0; i < handlers.length; i++) {
            ...
            (function (hc, dd) {
                dd.on("drag", function (ev) {
                    ...
                    var dragNodeP = $(dd.get("dragNode")).parent(".hotspot");
                    for (i = 0; i < ATTRS_ORDER.length; i++) {
                        if (pos[i]) {
                            dragNodeP.css(ATTRS_ORDER[i], pos[i]);
                        }
                    }
                    self.fire('resize', {
                        handler: hc,
